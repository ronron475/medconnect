...
expect_true(
    str_contains($html, 'outside the scope of the medConnect Assistant')
    || (str_contains($html, 'medConnect') && str_contains($html, 'City Health Office') && str_contains($html, 'health-related')),
    'out-of-scope copy'
);
...
expect_true(
    str_contains($htmlHil, 'wala ini sa saklaw sang medConnect Assistant')
    || (str_contains($htmlHil, 'medConnect') && str_contains($htmlHil, 'City Health Office') && str_contains($htmlHil, 'health-related')),
    'hiligaynon out-of-scope copy'
);
