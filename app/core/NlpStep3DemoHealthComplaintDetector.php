<?php
/**
 * TRIAL ONLY — universal health-complaint domain detector for nlp_step3_demo.
 *
 ...
 *
 * Does NOT diagnose. Does NOT triage. Does NOT replace existing NLP.
 * Returns domain confidence + explainable signals for demo routing.
 */
