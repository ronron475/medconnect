...
final class FaqChatbotLanguageBridge
{
    ...
    private const HIL_PHRASES = [
        ...
        ['buligi ko', 'help me'],
        ['salamat gid', 'thank you very much'],
        ['grabe lang', 'very intense stressed surprised'],
        ['hay grabe', 'sigh stressed sad'],
        ['pero nahadlok ko', 'but i am scared mixed feelings'],
        ['pero kapoy ko', 'but i am tired mixed feelings'],
        ['indi ko gusto', 'i do not want reluctant'],
        ['indi gid ko gusto', 'i really do not want reluctant'],
        ['wala ko gusto', 'i do not want reluctant'],
        ['amo gid', 'yes exactly affirmation'],
        ['oo gid', 'yes affirmation'],
        ['amo man', 'yes affirmation'],
        ['oo man', 'yes affirmation'],
        ['naguol ko', 'i am grieving sad'],
        ['naghuoy ko', 'i am weary sad tired'],
        ['nagkasubo ko', 'i am sad grieving'],
        ['subo gid ko', 'i am very sad'],
        ['subo gid ya', 'very sad frustrating'],
        ['badtrip ko', 'frustrated badtrip'],
        ['bad trip ko', 'frustrated badtrip'],
        ['naglibog ko', 'i am confused'],
        ['libog ko', 'i am confused'],
        ['kinabahan ko', 'i am nervous anxious'],
        ['sobra stress ko', 'very stressed overwhelmed'],
        ['sobra nga stress', 'very stressed overwhelmed'],
        ['pagod na gid ko ya', 'exhausted tired burnout'],
        ['kapoy na ko sa tanan', 'tired exhausted burnout'],
        ...
        ['miss ko sila', 'miss them lonely affectionate'],
        ['kinahanglan ko sang dulungan', 'need help urgent distress'],
        ['buligi ko daw', 'help me please panic'],
        ['tabangi ko daw', 'help me please panic'],
        ['ano himuon ko na', 'what should i do panic confused'],
        ['daw wala na ko gana', 'overwhelmed no motivation tired'],
        ['wala gid ko gana', 'no motivation bored overwhelmed'],
        ['okay pero sad', 'mixed feelings okay but sad'],
        ['okay lang pero nahadlok', 'mixed feelings okay but afraid'],
        ['pero ginakulbaan ko', 'mixed feelings but anxious'],
        ['pero nabalaka ko', 'mixed feelings but worried'],
        ['pero akig ko', 'mixed feelings but angry'],
        ['gasakit lawas ko', 'body pain sick'],
        ['may sipon ko', 'have cold sick cough'],
        ['may ubo ko', 'have cough sick'],
        ['gasuka ko subong', 'nauseous sick vomiting'],
        ...
        ['gaulan pa', 'raining bad weather'],
        ['grabe ang ulan', 'heavy rain bad weather'],
        ['indi ko makaguwa', 'cannot go outside bad weather'],
        ['basi indi ko makakadto', 'might not be able to go worried'],
        ...
        ['gadula-dula ang signal', 'intermittent signal connectivity problem'],
        ...
        ['indi ko makakadto sa health center', 'cannot go to health center access problem'],
        ['wala ko budget', 'no budget financial problem'],
        ['indi ko kaya magbayad', 'cannot afford pay financial problem'],
        ['may libre nga consultation', 'free consultation financial question'],
        ['masaligan ni bala', 'is this trustworthy safe reliable'],
        ['safe bala ni', 'is this safe secure'],
        ['safe bala akon information', 'is my information safe privacy'],
        ...
        ['masaligan ni bala ang system', 'is the system trustworthy safe'],
        ['paano kung mag-error', 'what if error system problem'],
        ['nadula akon appointment', 'lost my appointment system problem'],
        ['di ko makita ang doctor', 'cannot see doctor appointment problem'],
        ['diin ko makadto', 'where should i go navigation confused'],
        ['ano ubrahon ko', 'what should i do confused'],
        ['ano na himuon ko', 'what should i do now confused'],
        ['tabangi ko bi', 'help me please'],
        ['buligi ko bi', 'help me please'],
        ['wala gid ko okay', 'not okay at all sad worried'],
        ['indi ko kasabat', 'i do not understand confused'],
        ['gakulbaan ko', 'i am anxious nervous'],
        ['gakulbaan ko magpa-check', 'anxious about checkup scared of doctor'],
        ['gakulbaan ko magpa-check up', 'anxious about checkup scared of doctor'],
        ['sakit gid ya', 'very painful very bad sick'],
        ['budlay gid', 'very hard frustrated struggling'],
        ['paano na lang ni', 'what now worried uncertain'],
        ['paano na ni', 'what now worried uncertain'],
        ...
        ['gusto ko na mag-untat', 'want to stop hopeless suicide'],
        ['gusto ko mawala', 'want to disappear hopeless'],
        ['mas maayo pa siguro kung wala na ko', 'better if i were gone hopeless'],
        ['mabuhi pa ko ni ayhan', 'will i survive worried hopeless'],
        ['mabuhi pa ko', 'will i survive worried'],
        ['hays', 'sigh sad tired'],
        ['hay naku', 'oh no sigh sad worried'],
        ['grabe', 'very intense stressed surprised'],
        ['nahadlok', 'scared afraid'],
        ['di ko kaya', 'cannot handle it distressed hopeless'],
        ['wala ko idea', 'no idea confused'],
        ['ano na', 'what now uncertain'],
        ['ngaa amo ni', 'why is this confused frustrated'],
        ['tani okay lang', 'hopefully okay relieved hopeful'],
        ['gaulan kag wala signal', 'raining and no signal weather connectivity problems'],
        ['kung wala kwarta paano ko', 'no money how can i financial worried'],
    ...
    private const HIL_TOKENS = [
        ...
        'masaligan' => 'trustworthy reliable safe',
        'confidential' => 'confidential private privacy',
        'kasabat' => 'understand',
        'gakulbaan' => 'anxious nervous',
        'ginakapoy' => 'tired exhausted',
    ...
    public static function looksHiligaynon(string $text): bool
    {
        ...
        $markers = ['gid', 'guid', 'sang', 'kag', 'indi', 'nabalaka', 'nahadlok', 'kasubo', 'kapoy', 'nalibog', 'buligi', 'tabangi', 'diin', 'amo', 'subong', 'kon', 'nga', 'halin', 'maayong', 'kumusta', 'musta', 'palihog', 'lawas', 'dughan', 'hilanat', 'nakalimtan', 'rehistro', 'konsultasyon', 'nasubo', 'malipayon', 'kulbaan', 'kasabot', 'kabalo', 'nabudlay'];
        $hits = 0;
    ...
    {
        $work = FaqChatbotEmotionShorthand::expand($text);
        $work = FaqEmotionEngine::normalizeText($work);
        if ($work === '') {
            return '';
        }
