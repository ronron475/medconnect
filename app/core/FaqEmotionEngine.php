...
final class FaqEmotionEngine
{
    ...
    private static function boostRules(): array
    {
        return [
            ...
            ['angry', '/\b(angry|galit|akig|akig\s+ko|akig\s+gid|nagalit|init\s+ulo)\b/ui', 2.0],
            ...
            ['crying', '/\b(crying|umiiyak|naga\s*hilib|naga\s*hibi|nagahibi|gahibi|gailuha)\b/ui', 2.0],
            ...
            ['afraid', '/\b(afraid|scared|fearful|nahadlok|nahadlok\s+ko|nahadlok\s+gid|natakot|takot|afraid\s+of\s+(the\s+)?doctor|nahadlok\s+.*doktor|fear\s+of\s+hospital)\b/ui', 2.2],
    ...
    private static function empathyTable(): array
    {
        ...
        $table = [
            'en' => [
                ...
                'afraid' => ['_default' => 'I understand you feel afraid. I\'m here with you — we can take the next step slowly.'],
                'fearful' => ['_default' => 'I understand you feel afraid. I\'m here with you — we can take the next step slowly.'],
                'nervous' => ['_default' => 'Nerves make sense. I\'ll keep this calm and simple.'],
                'crying' => ['_default' => 'It\'s okay to cry. You\'re not alone here. We can go one small step at a time.'],
                'tired' => ['_default' => 'That exhaustion is real. Rest if you can — I can help with a small practical next step when you\'re ready.'],
                'disappointed' => ['_default' => 'I\'m sorry it didn\'t go as you hoped. Let\'s see what we can still do together.'],
            ...
            'fil' => [
                ...
                'afraid' => ['_default' => 'Naiintindihan ko na natatakot ka. Nandito ako — dahan-dahan lang ang susunod na hakbang.'],
                'nervous' => ['_default' => 'Natural ang kaba. Panatilihin nating simple at mahinahon.'],
                'crying' => ['_default' => 'Okay lang umiyak. Hindi ka nag-iisa. Isa-isang hakbang lang.'],
                'tired' => ['_default' => 'Totoo ang pagod. Magpahinga kung maaari — may maliit na hakbang tayo kapag handa ka.'],
                ...
                'disappointed' => ['_default' => 'Paumanhin na hindi natuloy ang inaasahan mo. Tingnan natin ang maaari pa nating gawin.'],
                'bored' => ['_default' => 'Normal ang mababang gana. Kapag handa ka, matutulungan kita sa praktikal na hakbang sa medConnect.'],
                'irritated' => ['_default' => 'Paumanhin na nakakainis ngayon. Isa-isang bagay lang.'],
                'jealous' => ['_default' => 'Valid iyon. Nandito ako kung kailangan mo ng healthcare access.'],
            ...
            'hil' => [
                ...
                'afraid' => ['_default' => 'Nasabtan ko nga nahadlok ka. Diri ako — mahinay lang ang sunod nga hakbang.'],
                'fearful' => ['_default' => 'Nasabtan ko nga nahadlok ka. Diri ako — mahinay lang ang sunod nga hakbang.'],
                'nervous' => ['_default' => 'Natural ang kulba. Simplehon ta kag malinong.'],
                'crying' => ['_default' => 'Okay lang maghibi. Indi ka isa. Isa ka hakbang lang.'],
                'tired' => ['_default' => 'Real ang kapoy. Magpahulay kon pwede — may gamay nga hakbang kita kon ready ka.'],
