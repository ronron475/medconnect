...
final class FaqChatbotEmotionShorthand
{
    ...
    private const PHRASE_MAP = [
        ...
        ['nahadlok gid', 'nahadlok gid scared afraid'],
        ['kulbaan gid', 'kulbaan gid anxious nervous'],
        ['nasubo gid', 'nasubo gid sad'],
        ['akig gid', 'akig gid angry'],
        ['naga hibi', 'naga hibi crying sad'],
        ['kapoy na gid', 'kapoy na gid tired exhausted'],
        ['naga kurog', 'naga kurog anxious nervous'],
        ['init ulo', 'init ulo angry'],
        ['nasubo gid', 'nasubo gid sad'],
        ['nahidlaw', 'nahidlaw homesick lonely'],
        ['kasalanan ko', 'kasalanan ko guilty'],
