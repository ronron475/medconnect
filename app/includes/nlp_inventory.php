...
function nlp_inventory_catalog(): array
{
    ...
    $items = [
        ...
        ['id' => 'cds_context_json', 'label' => 'Clinical Context Rules (JSON)', 'category' => 'CDS Expansion', 'path' => '/data/nlp/clinical_context_rules.json', 'description' => 'Contextual multi-factor triage reasoning rules.', 'json' => true],
