...
function bhw_nav_groups(): array
{
    return [
        ...
        [
            ...
            'description' => 'Follow up on doctor referrals for your barangay',
            'children' => [
                ['file' => 'referral/status.php', 'label' => 'Referral Follow-up', 'hint' => 'Contacted, acted on, notes', 'icon' => 'share', 'sidebar' => true],
            ],
        ],
        [
            'id' => 'followup',
