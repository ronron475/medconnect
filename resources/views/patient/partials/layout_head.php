...
?>
  ...
  <?php
  $patientSpacingCss = ASSETS_PATH . '/css/patient-spacing.css';
  $patientSpacingCssVer = file_exists($patientSpacingCss) ? (int) filemtime($patientSpacingCss) : time();
  ?>
  <link rel="stylesheet" href="<?= ASSET_BASE ?>/assets/css/patient-spacing.css?v=<?= $patientSpacingCssVer ?>"/>
