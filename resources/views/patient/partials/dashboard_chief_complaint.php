...
>
  ...
  <div class="patient-triage-alert patient-triage-alert--warning is-visible" role="status" style="margin:0 0 16px;">
    ...
    <p class="text-sm" style="margin:6px 0 10px;">Doctors with open slots today are ready. Each shows only their earliest available time — you may choose any eligible doctor.</p>
  ...
  <form
    ...
    class="pdash-review-form<?= !empty($preliminary_payload['assessment_in_progress'] ?? false) ? ' is-followup-active' : '' ?>"
    novalidate
