        ...
        <div id="otp-email-panel">
          <div class="form-group">
            ...
            <div class="input-wrap">
              ...
              <input type="email" id="otp-email" placeholder="your.email@gmail.com" autocomplete="email" data-email-gmail="1" required />
            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-wrap">
                    ...
                    <button type="button" class="toggle-pwd" id="toggle-reg-pwd" aria-label="Show password">
                      <svg id="reg-eye-icon" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                    </button>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-wrap">
                    ...
                    <button type="button" class="toggle-pwd" id="toggle-reg-confirm-pwd" aria-label="Show confirm password">
                      <svg id="reg-confirm-eye-icon" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                    </button>
                  </div>
