...
<div class="prov-dash" data-live-dashboard>
  ...
  <div class="prov-dash-grid">
    ...
    <!-- Row 1: Consultation Activity | Live Status -->
    <div class="prov-dash-row">
    ...
    <!-- Row 2: Upcoming Consultations | Review Triage -->
    <div class="prov-dash-row">
      <div class="prov-dash-main">
    ...
    <!-- Row 3: Recent Notifications | Recent Activity + Session Recordings -->
    <div class="prov-dash-row">
      <div class="prov-dash-main">
