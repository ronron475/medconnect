...
<div class="bhw-reports-page" id="bhwReportsRoot" data-barangay="<?= $barangay_label ?>">
  ...
  <div class="bhw-card bhw-reports-filters no-print">
    <div class="bhw-reports-filter-primary">
      <div class="bhw-reports-filter-field">
        <label class="form-label" for="rf_date_from">From</label>
        <input type="date" class="form-control" id="rf_date_from">
      </div>
      <div class="bhw-reports-filter-field">
        <label class="form-label" for="rf_date_to">To</label>
        <input type="date" class="form-control" id="rf_date_to">
      </div>
      <div class="bhw-reports-filter-field bhw-reports-filter-field--year">
  ...
  <div class="bhw-reports-summary" id="bhwSummaryCards" aria-live="polite">
    <div class="bhw-reports-skeleton-grid" id="bhwSummarySkeleton">
      <?php for ($i = 0; $i < 4; $i++): ?><div class="bhw-reports-skeleton-card"></div><?php endfor; ?>
    </div>
    <div class="bhw-reports-metric-groups" id="bhwSummaryRow" hidden></div>
  </div>
  ...
  <div class="bhw-reports-panels">
    <section class="bhw-reports-panel is-active" data-panel="patients">
      <div class="row g-3">
        <div class="col-lg-8">
          <div class="bhw-card bhw-chart-card">
            <h3>Monthly Registration Trend</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--line"><canvas id="chart_pat_monthly"></canvas></div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="bhw-card bhw-chart-card">
            <h3>Gender Distribution</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--ring"><canvas id="chart_pat_gender"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Age Distribution</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar"><canvas id="chart_pat_age"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Purok Distribution</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar"><canvas id="chart_pat_purok"></canvas></div>
          </div>
        </div>
      </div>
    </section>
    <section class="bhw-reports-panel" data-panel="consultations">
      <div class="row g-3">
        <div class="col-md-4">
          <div class="bhw-card bhw-chart-card">
            <h3>By Status</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--ring"><canvas id="chart_con_status"></canvas></div>
          </div>
        </div>
        <div class="col-md-8">
          <div class="bhw-card bhw-chart-card">
            <h3>Monthly Consultations</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--line"><canvas id="chart_con_monthly"></canvas></div>
          </div>
        </div>
        <div class="col-12">
          <div class="bhw-card bhw-chart-card">
            <h3>Provider Distribution</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar-tall"><canvas id="chart_con_provider"></canvas></div>
          </div>
        </div>
      </div>
    </section>
    <section class="bhw-reports-panel" data-panel="triage">
      <div class="row g-3">
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Risk Levels</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--ring"><canvas id="chart_tri_urgency"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>AI Classifications</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar"><canvas id="chart_tri_class"></canvas></div>
          </div>
        </div>
        <div class="col-12">
          <div class="bhw-card bhw-chart-card">
            <h3>Most Common Symptoms</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar-tall"><canvas id="chart_tri_symptoms"></canvas></div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row g-3">
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            ...
            <div class="bhw-chart-wrap bhw-chart-wrap--ring"><canvas id="chart_ref_type"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Referral Status</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar"><canvas id="chart_ref_status"></canvas></div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row g-3">
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            ...
            <div class="bhw-chart-wrap bhw-chart-wrap--bar"><canvas id="chart_fol_overview"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Home Visit Types</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--ring"><canvas id="chart_fol_visits"></canvas></div>
          </div>
        </div>
      ...
      <div class="row g-3">
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            ...
            <div class="bhw-chart-wrap bhw-chart-wrap--bar-tall"><canvas id="chart_dis_conditions"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Top Symptoms (Triage)</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--bar-tall"><canvas id="chart_dis_symptoms"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Age Groups</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--ring"><canvas id="chart_dis_age"></canvas></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="bhw-card bhw-chart-card">
            <h3>Monthly Triage Trend</h3>
            <div class="bhw-chart-wrap bhw-chart-wrap--line"><canvas id="chart_dis_monthly"></canvas></div>
          </div>
        </div>
      </div>
    </section>
