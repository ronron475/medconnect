...
<head>
  ...
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/hero-signin-panel.css?v=<?= (int) @filemtime(ASSETS_PATH . '/css/hero-signin-panel.css') ?>" />
  ...
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/landing-about-team.css?v=10" />
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/landing-responsive.css?v=19" />
...
<script src="<?= $asset ?>/assets/js/script.js?v=20260916c"></script>
