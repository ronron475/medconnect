...
<head>
  ...
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/style.css?v=20260702a" />
  ...
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/landing-announcements.css?v=21" />
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/landing-nav.css?v=2.13" />
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/landing-fab.css?v=11" />
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/landing-fab-modals.css?v=2" />
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/signin-req-drawer.css?v=7" />
  <link rel="stylesheet" href="<?= $asset ?>/assets/css/signin-card-polish.css?v=1" />
    ...
    <div class="contact-grid">
      ...
      <div class="contact-col contact-col--brand">
        ...
        <div class="contact-brand">
          ...
          <img src="<?= $asset ?>/assets/img/medcon_logo.png" alt="medConnect" class="contact-logo"/>
      ...
      <div class="contact-col">
        ...
        <ul class="contact-links">
          ...
          <li><a href="#">About medConnect</a></li>
...
<div id="signin-modal" class="signin-modal-overlay" role="dialog" aria-modal="true" aria-label="Sign In" hidden>
    ...
    <div class="signin-modal-inner">
      ...
      <div class="card-top">
        ...
        <div class="card-top__text">
          ...
          <p class="card-sub">Access your MedConnect account securely.</p>
      ...
      <p class="provider-note">
        ...
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>

        <span class="provider-note__text"><strong>Healthcare provider accounts are created and managed exclusively by the system administrator.</strong></span>
      ...
      <div class="emergency-note" role="note">
        ...
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>

        <span><strong>For medical emergencies,</strong> please proceed immediately to the nearest healthcare facility or contact your local emergency services.</span>
...
<script src="<?= $asset ?>/assets/js/landing-interactions.js" defer></script>
