...
$projectParagraphs = [
    'We are <strong>Ronald Gonzales</strong>, <strong>Janica Jade Sumagaysay</strong>, and <strong>Joy Gonzaga</strong>, fourth-year Bachelor of Science in Information System (BSIS) students at our college. As aspiring Information System professionals, we are passionate about leveraging technology to develop innovative, practical, and user-centered solutions that address real-world challenges and improve the quality of public services.',
    'United by our shared commitment to innovation, collaboration, and community development, we developed <strong>medConnect: An Online Medical Video Call Consultation and AI-Powered Triage System</strong> as our capstone project. This system was designed to support the City Health Office by improving healthcare accessibility, streamlining medical consultation workflows, and enhancing patient management through modern digital technologies.',
    ...
    'We hope that medConnect serves as a meaningful contribution to the digital transformation initiatives of the City Health Office and demonstrates how information technology can improve healthcare accessibility, enhance service delivery, and create lasting positive change for future generations.',
];
  ...
  <div class="services-container">
    ...
    <div class="services-header about-team-section__header">
      ...
      <p class="services-desc landing-reveal-desc about-team-section__intro">
        ...
        <span class="services-brand">medConnect</span> to improve healthcare accessibility for the City Health Office.
      </p>
    </div>
    ...
    <div class="about-team-section__layout">
      ...
      <div class="about-team-section__story">
        ...
        <div class="about-team-section__partners">
          <img src="<?= htmlspecialchars($asset) ?>/assets/img/bcclogo.png" alt="College partner" class="about-team-section__bcc-logo" width="48" height="48" />
          <div>
            <span class="about-team-section__partners-label">Developed in partnership with</span>
            <span class="about-team-section__partners-name">City Health Office</span>
          </div>
        </div>
      </div>
