...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-left">
      <h1 class="hero-title">
        medConnect:<br/>
        <span class="hero-accent">AI-Powered Medical</span><br/>
        Video Consultation &amp; Triage
      </h1>
      <p class="hero-sub">
        Smart triage. Instant consultations. Powered by AI to get you right care, right when you need it.
      </p>
      <div class="hero-btns">
        <a href="#" class="btn-primary-hero">Book a Consultation</a>
