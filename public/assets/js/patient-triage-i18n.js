...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      msg_non_urgent: 'Triage result: NON-URGENT. You may add optional supporting evidence, then submit for provider review.',
      ...
      step_nu_1: 'Supporting evidence is optional',
      step_nu_2: 'Submit your patient complaint for provider review',
      step_nu_3: 'Seek urgent or emergency care if symptoms worsen',
      step_urg_triage_1: 'You may add optional supporting evidence before submitting',
      step_urg_triage_2: 'After submit, book the earliest available consultation',
      ...
      evidence_hint: 'Upload a photo or short video for your doctor to review. This does not affect triage or review priority.',
      evidence_choose: 'Choose photo or video',
      evidence_remove: 'Remove',
      evidence_limits: 'Photos up to 5 MB. Videos up to 25 MB (MP4 or WebM).',
      ...
      err_file_type: 'Please choose a JPG, PNG, WEBP photo or MP4/WebM video.',
      err_video_size: 'Video must be 25 MB or smaller.',
      err_photo_size: 'Photo must be 5 MB or smaller.',
    ...
    fil: {
      ...
      msg_non_urgent: 'Resulta ng triage: NON-URGENT. Maaari kang magdagdag ng opsyonal na supporting evidence, pagkatapos ay i-submit para sa review ng provider.',
      msg_urgent: 'Batay sa mga sintomas na ibinigay mo, maaaring kailanganin ang madaliang pangangalagang medikal. Resulta ng triage: URGENT. Pagkatapos mong mag-submit, maaari kang mag-book ng pinakamaagang consultation.',
      ...
      step_nu_1: 'Opsyonal ang supporting evidence',
      step_nu_2: 'I-submit ang iyong patient complaint para sa review ng provider',
      step_nu_3: 'Magpagamot nang apurahan o emergency kung lumala ang sintomas',
      step_urg_triage_1: 'Maaari kang magdagdag ng opsyonal na supporting evidence bago mag-submit',
      step_urg_triage_2: 'Pagkatapos mag-submit, mag-book ng pinakamaagang consultation',
      ...
      doctor: 'Doktor',
      submit_complaint: 'I-submit ang patient complaint',
      submit_review: 'I-submit para sa review ng doktor',
      submitting: 'Isinusumite…',
      assessing: 'Tinitingnan ang urgency…',
      evidence_label: 'Supporting Evidence',
      evidence_optional: '(opsyonal)',
      evidence_hint: 'Mag-upload ng larawan o maikling video para sa review ng doktor. Hindi nito binabago ang triage o prayoridad.',
      evidence_choose: 'Pumili ng larawan o video',
      evidence_remove: 'Alisin',
      evidence_limits: 'Larawan hanggang 5 MB. Video hanggang 25 MB (MP4 o WebM).',
      ...
      err_file_type: 'Pumili ng JPG, PNG, WEBP na larawan o MP4/WebM na video.',
      err_video_size: 'Ang video ay dapat 25 MB o mas maliit.',
      err_photo_size: 'Ang larawan ay dapat 5 MB o mas maliit.',
    ...
    hil: {
      ...
      msg_non_urgent: 'Resulta sang triage: NON-URGENT. Mahimo mo magdugang optional nga supporting evidence, dayon i-submit para sa review sang provider.',
      msg_urgent: 'Base sa mga sintomas nga imo ginhatag, mahimo nga kinahanglan mo ang madali nga pag-atipan. Resulta sang triage: URGENT. Pagkatapos mo mag-submit, mahimo ka mag-book sang pinakaaga nga consultation.',
      ...
      step_nu_1: 'Optional ang supporting evidence',
      step_nu_2: 'I-submit ang imo patient complaint para sa review sang provider',
      step_nu_3: 'Magpangita urgent ukon emergency nga pag-atipan kon maglala ang sintomas',
      step_urg_triage_1: 'Mahimo ka magdugang optional nga supporting evidence antes mag-submit',
      step_urg_triage_2: 'Pagkatapos mag-submit, mag-book sang pinakaaga nga consultation',
      ...
      doctor: 'Doktor',
      submit_complaint: 'I-submit ang patient complaint',
      submit_review: 'I-submit para sa review sang doktor',
      submitting: 'Gina-submit…',
      assessing: 'Ginausisa ang urgency…',
      evidence_label: 'Supporting Evidence',
      evidence_optional: '(optional)',
      evidence_hint: 'Mag-upload sang litrato ukon mabaskog nga video para sa review sang doktor. Indi ini magbag-o sang triage ukon prioridad.',
      evidence_choose: 'Pili-a ang litrato ukon video',
      evidence_remove: 'Kuhaa',
      evidence_limits: 'Litrato hasta 5 MB. Video hasta 25 MB (MP4 ukon WebM).',
      ...
      err_file_type: 'Pili-a ang JPG, PNG, WEBP nga litrato ukon MP4/WebM nga video.',
      err_video_size: 'Ang video dapat 25 MB ukon mas diotay.',
      err_photo_size: 'Ang litrato dapat 5 MB ukon mas diotay.',
  ...
  function applyPageCopy(lang) {
    ...
    if (submit) {
      var review = submit.getAttribute('data-submit-kind') === 'review';
      submit.dataset.defaultLabel = t(review ? 'submit_review' : 'submit_complaint', null, code);
