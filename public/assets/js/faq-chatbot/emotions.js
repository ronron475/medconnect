...
(function (global) {
  ...
  const BOOST_RULES = [
    ...
    { emotion: EMOTION.AFRAID, re: /\b(nahadlok|natatakot|scared|afraid|hadlok|nahadlok\s+gid)\b/i, w: 2.2 },
    { emotion: EMOTION.SAD, re: /\b(sad|lungkot|kasubo|subo|nasubo|malungkot|naguol|nasubo\s+gid)\b/i, w: 2 },
    { emotion: EMOTION.CRYING, re: /\b(crying|umiiyak|naga\s*hilib|naga\s*hibi|gailuha|gahibi|nagahibi)\b/i, w: 2 },
    { emotion: EMOTION.ANGRY, re: /\b(angry|galit|akig|akig\s+ko|nagalit|akig\s+gid)\b/i, w: 2 },
    { emotion: EMOTION.WORRIED, re: /\b(worri|concerned|nabalaka|kabalaka|nagabalaka)\b/i, w: 2 },
    { emotion: EMOTION.ANXIOUS, re: /\b(anxious|anxiety|ginakulbaan|gakulbaan|kulba|kulbaan\s+ko|kulbaan\s+gid)\b/i, w: 2 },
    { emotion: EMOTION.PANIC, re: /\b(panic|ginapanik|naga-?panic)\b/i, w: 2.5 },
    { emotion: EMOTION.TIRED, re: /\b(tired|pagod|kapoy|ginakapoy|kapoy\s+ko|kapoy\s+na\s+ko|wala\s+na\s+(ko\s+)?kusog)\b/i, w: 2 },
    ...
    { emotion: EMOTION.LONELY, re: /\b(lonely|nag-iisa|isa\s+lang|wala\s+(ako|ko)\s+(makakausap|maistoryahan)|wala\s+upod)\b/i, w: 2 },
    ...
    { emotion: EMOTION.DISAPPOINTED, re: /\b(disappoint|nadismaya|dismaya|wala\s+natuman)\b/i, w: 2 },
    { emotion: EMOTION.EMBARRASSED, re: /\b(embarrass|nahihiya|nahuya|hiya\s+ko)\b/i, w: 2 },
    { emotion: EMOTION.ASHAMED, re: /\b(ashamed|shame|nakahuya\s+gid|huya\s+gid)\b/i, w: 2 },
    { emotion: EMOTION.GUILTY, re: /\b(guilty|guilt|nagkasala|kasalanan\s+ko|basol\s+ko)\b/i, w: 2 },
    ...
    { emotion: EMOTION.OVERWHELMED, re: /\b(overwhelm|overwhelmed|daw\s+wala\s+na\s+ko\s+gana|wala\s+na\s+akong\s+gana|sobra\s+na\s+gid)\b/i, w: 2 },
