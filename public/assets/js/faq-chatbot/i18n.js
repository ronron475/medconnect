...
(function (global) {
  ...
  const UI_STRINGS = {
    en: {
      ...
      restrictedBanner: '🔒 Chat temporarily limited —',
      restrictedRemaining: ' remaining',
      restrictedPlaceholder: 'Chat limited — wait {n}s…',
      ...
      voiceUnsupported: 'Voice is not supported in this browser. Please type your question.',
      voiceError: 'Could not hear you. Please try again or type your message.',
      voiceNoSpeech: 'No speech detected. Try again or type your message.',
      voiceMicDenied: 'Microphone access was denied.',
      voiceRestricted: 'Chat is temporarily restricted.',
      voiceSpeakOn: 'Read replies aloud (on)',
      voiceSpeakOff: 'Read replies aloud (off)',
    ...
    fil: {
      ...
      voiceListen: 'Magsalita ng tanong',
      voiceListening: 'Nakikinig…',
      voiceProcessing: 'Pinoproseso ang boses…',
      voiceUnsupported: 'Hindi suportado ang boses sa browser na ito. Pakitype ang tanong.',
      voiceError: 'Hindi narinig. Subukan muli o mag-type.',
      voiceNoSpeech: 'Walang narinig. Subukan muli o mag-type.',
      voiceMicDenied: 'Tinanggihan ang access sa mikropono.',
      voiceRestricted: 'Pansamantalang restricted ang chat.',
      voiceSpeakOn: 'Basahin ang sagot nang malakas (on)',
      voiceSpeakOff: 'Basahin ang sagot nang malakas (off)',
    ...
    hil: {
      ...
      voiceListen: 'Maghambal sang pamangkot',
      voiceListening: 'Nakapamati…',
      voiceProcessing: 'Ginaproseso ang tingog…',
      voiceUnsupported: 'Indi suportado ang tingog sa sini nga browser. Palihog i-type ang pamangkot.',
      voiceError: 'Indi makita. Sulayi liwat ukon mag-type.',
      voiceNoSpeech: 'Wala nakita nga tingog. Sulayi liwat ukon mag-type.',
      voiceMicDenied: 'Gindula ang access sa mikropono.',
      voiceRestricted: 'Temporaryo nga restricted ang chat.',
      voiceSpeakOn: 'Basaha ang sabat (on)',
      voiceSpeakOff: 'Basaha ang sabat (off)',
  ...
  const EMOTION_ALIASES = {
    ...
    grief: 'grief', embarrassment: 'embarrassed', shame: 'ashamed',
    irritation: 'irritated', uncertainty: 'uncertain',
  };
  ...
  const EMPATHY = {
    en: {
      ...
      grief: { _default: 'I\'m truly sorry for your loss or pain. Grief takes time — when you\'re ready, I can help you access support or healthcare on medConnect.' },
      embarrassed: { _default: 'It\'s okay to feel shy about health topics. I\'m here without judgment to help with medConnect services.' },
      ashamed: { _default: 'Thank you for sharing that. Seeking help is a brave step — I can guide you to City Health services comfortably.' },
      guilty: { _default: 'Guilt can feel heavy. Let\'s focus on one small helpful step — I can guide medConnect when you\'re ready.' },
      jealous: { _default: 'Those feelings can be hard. I\'m here to listen and help with healthcare access if you need it.' },
      bored: { _default: 'Low energy happens. When you\'re ready, I can help with something practical on medConnect.' },
      irritated: { _default: 'I hear that something feels irritating. Let\'s tackle one thing at a time together.' },
      surprised: { _default: 'I hear you — let me help clarify things step by step.' },
    ...
    fil: {
      ...
      grief: { _default: 'Taos-pusong pakikiramay. Walang takdang oras ang lungkot — handa ka na, matutulungan kitang ma-access ang suporta sa medConnect.' },
      embarrassed: { _default: 'Okay lang mahiya sa health topics — nandito ako nang walang paghatol.' },
      ashamed: { _default: 'Salamat sa pagbabahagi. Humingi ng tulong ay matapang — gagabayan kita sa City Health services.' },
      guilty: { _default: 'Mabigat ang guilt — subukan natin ang maliit na hakbang. Gagabayan kita sa medConnect.' },
      jealous: { _default: 'Mahirap ang mga damdaming iyan. Nandito ako para makinig at tumulong sa healthcare access.' },
      bored: { _default: 'Normal ang mababang gana. Kapag handa ka, matutulungan kitang sa praktikal na medConnect steps.' },
      irritated: { _default: 'Naririnig ko na nakakainis ngayon. Isa-isang hakbang lang tayo.' },
      surprised: { _default: 'Naririnig ko — ipapaliwanag ko nang hakbang-hakbang.' },
    ...
    hil: {
      ...
      grief: { _default: 'Nagakaluoy gid ako. Wala takdo nga oras ang kaguol — kon ready ka, matabangan ko ikaw sa suporta sa medConnect.' },
      embarrassed: { _default: 'Okay lang mahuya sa health topics — diri ako nga wala hatol.' },
      ashamed: { _default: 'Salamat sa pagpaambit. Mangayo bulig matapang gid — ginagiyahan ko ikaw sa City Health services.' },
      guilty: { _default: 'Mabug-at ang guilt — tilawi lang sang gamay nga hakbang. Ginagiyahan ko ikaw sa medConnect.' },
      jealous: { _default: 'Budlay ang amo sini nga pamatyag. Diri ako para mamati kag buligan sa healthcare access.' },
      bored: { _default: 'Normal ang wala gana. Kon ready ka, matabangan ko sa praktikal nga medConnect steps.' },
      irritated: { _default: 'Nabatian ko nga makalain subong. Isa ka hakbang lang anay.' },
      surprised: { _default: 'Nabatian ko — ipahayag ko pahuway-pahuway.' },
  ...
  const MODERATION = {
    en: {
      ...
      restrictedBadge: '🔒 Chat temporarily limited',
      restrictedBody: '<p>Several invalid or repetitive messages were detected. Please wait before sending another message.</p><p>Please wait <strong data-fcb-cooldown>{n}</strong> seconds.</p>',
      spam: '<p>I couldn\'t understand that message. Please enter a clear question or describe your health concern.</p>',
    ...
    fil: {
      ...
      restrictedBadge: '🔒 Pansamantalang limitado ang chat',
      restrictedBody: '<p>Nakita ang ilang invalid o paulit-ulit na mensahe. Mangyaring maghintay bago magpadala muli.</p><p>Maghintay ng <strong data-fcb-cooldown>{n}</strong> segundo.</p>',
      spam: '<p>Hindi ko naintindihan ang mensaheng iyon. Mangyaring maglagay ng malinaw na tanong o ilarawan ang iyong health concern.</p>',
      actions: ['signIn', 'createAccount', 'bookAppointment', 'resetPassword', 'leaveMessage'],
    },
    hil: {
      ...
      restrictedBadge: '🔒 Temporaryo nga limitado ang chat',
      restrictedBody: '<p>Nakita ang pila ka invalid ukon paulit-ulit nga mensahe. Palihog hulat antes magpadala liwat.</p><p>Palihog hulat sang <strong data-fcb-cooldown>{n}</strong> ka segundo.</p>',
      spam: '<p>Indi ko maintindihan ang mensahe. Palihog magbutang sang malinaw nga pamangkot ukon ihambal ang imo health concern.</p>',
      actions: ['signIn', 'createAccount', 'bookAppointment', 'resetPassword', 'leaveMessage'],
    },
  };
