...
(function (global) {
  ...
  const FAQ_KEYWORDS = [
    ...
    'headache', 'ulo', 'masakit', 'checkup', 'book', 'appointment', 'ginakulbaan',
    'bhw', 'otp', 'video', 'camera', 'microphone', 'cancel', 'reschedule',
    'mabatian', 'makita', 'ginhawa', 'appointment', 'register', 'password',
    'reseta', 'prescription', 'records', 'soap', 'profile', 'logout', 'triage',
    'bukas', 'sarado', 'oras', 'kwarta', 'plete', 'bhw', 'privacy',
    'bakuna', 'buntis', 'prenatal', 'referral', 'announcement', 'notification',
  ];
