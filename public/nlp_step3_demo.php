...
<body class="nlp-demo-body">
  ...
  <main class="nlp-demo-main">
    <header class="nlp-demo-header">
      ...
      <p class="nlp-demo-sub">Adaptive chief-complaint interview trial. Existing NLP is primary; Gemini is a demo-only fallback for unclear follow-up answers (never triage). Vague pain asks severity (1–10) first. Final classes remain EMERGENCY / URGENT / NON-URGENT only.</p>
    </header>
  ...
  <script src="<?= htmlspecialchars($assetBase) ?>/assets/js/nlp_step3_demo.js?v=3.7"></script>
</body>
</html>
