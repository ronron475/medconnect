<?php
/**
 * Demo: Registration Step 3 — NLP validation UI + TRIAL adaptive chief-complaint interview.
 *
 * Local:  http://localhost/medconnect/public/nlp_step3_demo.php
 * Online: https://medconnect.bccbsis.com/public/nlp_step3_demo.php
 *
...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars($assetBase) ?>/assets/css/nlp_step3_demo.css?v=2.9" />
...
<body class="nlp-demo-body">
  ...
  <main class="nlp-demo-main">
    <header class="nlp-demo-header">
      ...
      <p class="nlp-demo-sub">Adaptive chief-complaint interview trial on top of the existing Hiligaynon → English → triage NLP. Incomplete complaints ask for missing details; final classes remain EMERGENCY / URGENT / NON-URGENT only.</p>
    </header>
      ...
      <form id="nlp-trial-form" class="nlp-demo-form nlp-trial-form" novalidate>
        <div class="nlp-field">
          ...
          <textarea
            ...
            rows="3"
            maxlength="1000"
            placeholder="e.g. sakit  ·  sakit akon tiyan  ·  Masakit gid akon dughan kag budlay magginhawa."
          ></textarea>
        </div>
        <div class="nlp-trial-actions">
          <button type="submit" class="nlp-btn-validate" id="nlp-trial-analyze">Analyze / Continue</button>
          <button type="button" class="nlp-btn-secondary" id="nlp-trial-reset">Reset conversation</button>
          <span class="nlp-trial-meta" id="nlp-trial-meta">New conversation</span>
        </div>
      </form>

      <div class="nlp-trial-chips" aria-label="Trial sample phrases">
        <button type="button" class="nlp-wv-chip nlp-wv-chip--routine" data-trial-text="sakit">sakit</button>
        <button type="button" class="nlp-wv-chip nlp-wv-chip--routine" data-trial-text="sakit akon tiyan">sakit akon tiyan</button>
        <button type="button" class="nlp-wv-chip nlp-wv-chip--urgent" data-trial-text="tiyan">tiyan (follow-up)</button>
        <button type="button" class="nlp-wv-chip nlp-wv-chip--urgent" data-trial-text="7">7 (severity)</button>
        <button type="button" class="nlp-wv-chip nlp-wv-chip--emergency" data-trial-text="Masakit gid akon dughan kag budlay magginhawa.">chest + breathing</button>
        <button type="button" class="nlp-wv-chip" data-trial-text="sakitgbgjgbvd">sakitgbgjgbvd</button>
        <button type="button" class="nlp-wv-chip" data-trial-text="hello">hello</button>
      </div>

      <div class="nlp-feedback" id="nlp-trial-feedback" role="status" hidden></div>
      <div class="nlp-results" id="nlp-trial-results" hidden aria-live="polite"></div>
    </section>

    <details class="nlp-legacy-details">
      <summary>Legacy profile validation demo (conditions / allergies)</summary>
  ...
  <script src="<?= htmlspecialchars($assetBase) ?>/assets/js/nlp_step3_demo.js?v=3.1"></script>
</body>
</html>
