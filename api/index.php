...
// Public PHP pages
if (preg_match('#^/(forgot_password|reset_password|setup_password|verify|verification-success|announcements|nlp_step3_demo|gemini_clinical_interview_demo)\.php$#i', $path, $m)) {
